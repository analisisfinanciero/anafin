                    ...
                    <>
                      ...
                      {showmatrizac && (
                        <View className="border border-gray-400 p-4 bg-white rounded-md">
                          <Text className="text-lg font-bold text-center mb-2">TABLA O MATRIZ ACTIVIDAD ECONÓMICA</Text>
                          <Text className="text-center text-base font-semibold text-blue-700 mb-2">{`AÑO ${date}`}</Text>
                          ...
                          <View className="flex-row border-t border-b py-2">
                            ...
                            <View className="flex-1 pl-2">
                              <Text className="text-blue-600 font-semibold">INVERSIÓN OTRAS ACTIVIDADES ECONÓMICAS</Text>
                              <Text>
                                {values.totalactias === 0
                                  ? "0.0%"
